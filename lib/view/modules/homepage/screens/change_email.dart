...
import 'package:jawla/view%20model/homepage/change_email_cubit.dart';
...
class ChangeEmail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        ...
        child: Builder(
          builder: (context) {
            var controller = context.read<ChangeEmailCubit>();
            return Scaffold(
              ...
              body: SingleChildScrollView(
                child: SizedBox(
                  ...
                  child: Column(
                    children: [
                      const CustomText(name: "Change Email"),
                      SizedBox(
                        height: 8.h,
                      ),
                      Padding(
